			...
			<tr>
				...
				/*
					...
					*/
					...
					<form action="Additional_Lectures_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
					...
					<select size="1" name="Second_Department_id" class="select">
						<option Value="0">«Œ — «·ﬁ”„</option>
							...
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «·Õ’…</td>
								<td class="tdDataControlR">
								<input  id="date1" type="text1" name="Second_Lecture_Date" class="textBox"></td>
							</tr>
							<tr>
								<td class="tdDataControlL">«·Õ’…</td>
								<td class="tdDataControlR">
