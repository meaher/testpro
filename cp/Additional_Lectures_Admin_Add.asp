			...
			<tr>
				...
				/*
					...
					*/
					...
					<form action="Additional_Lectures_Admin_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<td class="tdDataControlR">
					<select size="1" name="First_Department_id" class="select">
