					...
					<form action="Class_room_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0" dir="rtl">
							...
							<tr>
								...
								«·œ—«”Ì</td>
								<td class="tdDataControlR"><input  type="text" name="txtClass_Room" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								...
								<select size="1" name="SClass_Level" class="select">
										...
										<option value="11a">«·Õ«œÌ ⁄‘— √œ»Ì</option>
										<option value="11s">«·Õ«œÌ ⁄‘— ⁄·„Ì</option>
										<option value="12a">«·À«‰Ì ⁄‘— √œ»Ì</option>
										<option value="12s">«·À«‰Ì ⁄‘— ⁄·„Ì</option>
