					...
					<form action="Class_Room_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0" dir="rtl">
							...
							<tr>
								...
								<input  type="text" name="txtClass_Room" value="<%=Class_Room%>" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" align="left">«·„—Õ·…</td>
								<td class="tdDataControlR">
								<select size="1" name="SClass_Level" class="select">
						
										<option value="10" <%if Class_Level="10" then%> selected<%End if%>>«·⁄«‘—</option>
										<option value="11a" <%if Class_Level="11a" then%> selected<%End if%>>«·Õ«œÌ ⁄‘— √œ»Ì</option>
										<option value="11s" <%if Class_Level="11s" then%> selected<%End if%>>«·Õ«œÌ ⁄‘— ⁄·„Ì</option>
										<option value="12a" <%if Class_Level="12a" then%> selected<%End if%>>«·À«‰Ì ⁄‘— √œ»Ì</option>
										<option value="12s" <%if Class_Level="12s" then%> selected<%End if%>>«·À«‰Ì ⁄‘— ⁄·„Ì</option>
