...
<table class=" w3-left w3-hide-large w3-hover-cyan w3-large w3-theme" border="0" width="100%" id="table1"  style="border-style: solid; background-color: #FFFFFF !important">
	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<div class="PageTitle">
					<p>≈œ«—… √ﬁ”«„ «·„œ—”…<span lang="en-us"> </span>						
				<p style="text-align: right"><a href="Depart_Add.asp">≈÷«ﬁ… ﬁ”„ 
				ÃœÌœ</a></div>
				...
				sSql = "select * from Departments order by Department_ID"
						...
						<div>
							<table cellspacing="0" cellpadding="3" class="tblView">
								...
								<% End If %>
									...
									<a href="Depart_update.asp?id=<%=rs("Department_ID")%>">
									<span lang="en-us"> ⁄œÌ·</span></a></td>
									<td class="tdView" align="center" width="50">
									<a href="Depart_Delete.asp?id=<%=rs("Department_ID")%>">
