...
*/
				...
				%>						
								...
								<form action="Department_Admin_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<input  id="date" type="text" value=<%=Date()%> name="hdnwork_date" class="textBox"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="tdDataControlR">
								<input type="checkbox" name="cbleave_IN" value="ON" checked ></td>
							</tr>
							...
							<tr>
								...
								«·«‰’—«›</td>
								<td class="tdDataControlR">
								<input type="checkbox" name="cbLeave_Out" checked ></td>
							</tr>
							<tr>
				...
				%>						
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td class="tdDataControlL">«· «—ÌŒ </td>
								<td class="tdDataControlR">
								<input  id="date1" type="text" value=<%=Date()%> name="hdnwork_date" class="textBox"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" align="right">«”„ «·„ÊŸ›</td>
								<td class="tdDataControlR">
