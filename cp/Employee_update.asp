					...
					<form action="Employee_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0" dir="rtl">
							...
							<tr>
								...
								<td class="tdDataControlR">
								<input id="date" value="<%=Date_Start%>" type="text" name="txtDate_Start" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="tdDataControlR">
								<input id="date1" value="<%=Certificate_Date%>" type="text" name="txtCertificate_Date" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «· ⁄ÌÌ‰</td>
								<td class="tdDataControlR">
								<input id="date2" value="<%=Hiring_Date%>" type="text" name="txtHiring_Date" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «· ⁄ÌÌ‰ ﬂ„⁄·„</td>
								<td class="tdDataControlR">
								<input id="date3" value="<%=Teacher_Hiring_Date%>" type="text" name="txtTeacher_Hiring_Date" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
					...
					<form action="Employee_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0" dir="rtl">
							...
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «·ÊŸÌ›…</td>
								<td class="tdDataControlR">
								<input id="date4" value="<%=Date_Start%>" type="text" name="txtDate_Start" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL">
								Ê’› «·‘Â«œ…</td>
							...
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «·‘Â«œ…</td>
								<td class="tdDataControlR">
								<input id="date5" value="<%=Certificate_Date%>" type="text" name="txtCertificate_Date" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «· ⁄ÌÌ‰</td>
								<td class="tdDataControlR">
								<input id="date6" value="<%=Hiring_Date%>" type="text" name="txtHiring_Date" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «· ⁄ÌÌ‰ ﬂ„⁄·„</td>
								<td class="tdDataControlR">
								<input id="date7" value="<%=Teacher_Hiring_Date%>" type="text" name="txtTeacher_Hiring_Date" class="textBox" onchange="ValidateData()"></td>
							</tr>
							<tr>
								<td class="tdDataControlL">«·Ã‰”Ì…</td>
								<td class="tdDataControlR">
