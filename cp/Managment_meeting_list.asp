...
<table class=" w3-left w3-hide-large w3-hover-cyan w3-large w3-theme" border="0" width="100%" id="table1"  style="border-style: solid; background-color: #FFFFFF !important">
	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<div class="PageTitle">
					<p align=right><span lang="en-us">«Ã „«⁄«  </span>«·≈œ«—…<span lang="en-us"> </span></div>
				...
				nRecRange = 15
				nRecPerRow = 1
				pageName="Managment_meeting_list.asp?q=0"
						...
						<div>
							<table cellspacing="0" cellpadding="3" class="tblView">
								<thead>
									...
									«·«Ã „«⁄</td>
									<td class="tdViewHead" width="28%">⁄‰Ê«‰ 
									«·«Ã „«⁄</td>
									<td class="tdViewHead" width="33%">„·«ÕŸ« </td>
								...
								<% End If %>
									...
									<p>&nbsp;<%=rs("Meeting_Subject")%></td>
									
									<td class="tdView" width="33%">&nbsp;<%=rs("meeting_notes")%></td>
