					...
					<form action="School_letters_admin_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<option Value="0">Ã„Ì⁄ «·√ﬁ”«„</option>
							...
							<tr>
								...
								<td class="tdDataControlR">
								<input type="text" name="txtsubject" class="textBox"></td>
							</tr>
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «·ﬂ «»</td>
								<td class="tdDataControlR">
								<input  id="date" type="text" value="<%=DAY(Date())&"/"&Month(Date())&"/"&Year(Date())%>" name="txtLetter_date" class="textBox"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" valign="top">
								„·«ÕŸ«  «·≈œ«—…</td>
								<td class="tdDataControlR">
									<textarea name="txtnotes" id="txtDescEN" rows="3" cols="20"></textarea></td>
							</tr>
					...
					<form action="School_letters_admin_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<option Value="0">Ã„Ì⁄ «·√ﬁ”«„</option>
							...
							<tr>
								<td class="tdDataControlL"> «—ÌŒ «·ﬂ «»</td>
								<td class="tdDataControlR">
								<input  id="date1" type="text" value="<%=DAY(Date())&"/"&Month(Date())&"/"&Year(Date())%>" name="txtLetter_date" class="textBox"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" valign="top">
								„·«ÕŸ«  «·≈œ«—…</td>
								<td class="tdDataControlR">
									<textarea class="textarea" name="txtnotes" id="txtDescEN" rows="1" cols="20"></textarea></td>
							</tr>
							<tr class="tdDataControlR">
								<td class="tdDataControlL">«·„·› «·„—”· ··ﬁ”„</td>
								<td class="tdDataControlR">
