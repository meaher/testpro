			...
			<tr>
				...
				/*
					...
					*/
					...
					<form action="School_Letters_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr class="tdDataControlR">
								...
								<td class="tdDataControlR">
																	...
																	<a href="/School_Letters/<%=file_Letter%>">⁄—÷ «·„·›</a></td>
							</tr>
							<tr>
								<td class="tdDataControlL">«·„·› «·„—”· ≈·Ï 
								«·≈œ«—…</td>
								<td class="tdDataControlR">
