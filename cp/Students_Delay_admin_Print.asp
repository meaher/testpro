...
<table border="0" width="89%">
						<tr>
							...
							<p align="center"><b><font face="Impact" size="5">التأخر اليومي عن الحصص الدراسية<br>
							<%
	...
	<table class="tblMain" cellpadding="0" cellspacing="0" dir="rtl">
		...
		<tr>
			<td valign="top" class="tdMain" width="932">
				...
				nRecPerRow = 1
				ii=1
				pageName="Students_Delay_admin_print.asp?q=0"
				...
				<% If nTotalRecs > 0 Then %>
						<div>
							<table cellspacing="0" cellpadding="3" class="tblView">
								<thead>
									<td class="tdViewHead" width="7%" dir="rtl">تاريخ التأخر</td>
								...
								<% End If %>
									...
									<%
										...
										Else
												response.write "خطأ في الاسترجاع"
										end if
										Rss.close
									%>
