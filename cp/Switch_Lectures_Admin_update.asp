				...
				%>
					<form action="Switch_Lectures_Admin_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td class="tdDataControlL">موافق على تبديل الحصة</td>
								<td class="tdDataControlR">
								<input type="radio" value="ok" checked name="Status">موفق<span lang="en-us">
								</span>على التبديل&nbsp;&nbsp;&nbsp; &nbsp;
								<input type="radio" name="Status" value="no">رفض 
								التبديل</td>
							</tr>
							<tr>
								<td class="tdDataControlL">&nbsp;</td>
								<td class="tdDataControlR">
								<input type="submit" value="ارسال" name="tbnSubmit" class="button">
								</td>
							</tr>
							</table>
					</form>
