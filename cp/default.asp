...
<table class=" w3-left w3-hide-large w3-hover-cyan w3-large w3-theme" border="0" width="100%" id="table1"  style="border-style: solid; background-color: #FFFFFF !important">
	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<p>&nbsp;</p>
				<p>&nbsp;<form action="portal_loginCheck.asp" method=post onsubmit="return checkLoginData()" name="fLoginData">
				<div align="center">
					<table border="0" cellpadding="0" cellspacing="0" width="95%" style="border: 1px solid #999999; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bgcolor="#FFFFFF">
						...
						<tr>
							<td height="200" align="center">
								...
								<table border="0" width="90%" cellspacing="0" cellpadding="2" dir="rtl">
									<tr>
										<td align="right" >&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
...
<table class="w3-hide-medium w3-hide-small" border="0" width="100%"  cellspacing="0" cellpadding="0" style="border-style: solid; background-color: #F9FCFF !important">
	...
	<tr>
		...
		<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			...
			<form action="portal_loginCheck.asp" method=post onsubmit="return checkLoginData()" name="fLoginData">
				<div align="center">
