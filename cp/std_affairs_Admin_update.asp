						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td class="tdDataControlL" width="165">&nbsp;
									...
									«” „«—…  ”ÃÌ· ÿ«·»</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="std_reg_Form" value="no" <%if std_reg_form="no" then%> checked <%End if%>></td>
							</tr>
								...
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Last_certificate" value="no" <%if Last_certificate ="no" then%> checked <%End if%>></td>
							</tr>
								...
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Nationality_pic" value="no"  <%if Nationality_pic ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">’Ê—… «·»ÿ«ﬁ… «·„œ‰Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="ID_pic" value="no" <%if ID_pic ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">≈Ì’«· «·—”Ê„</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Fee_receipt" value="no"<%if Fee_receipt ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">’Ê—… «·ÃÊ«“</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="passport_pic" value="no" <%if passport_pic ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">’Ê—… ‘Â«œ… «·„Ì·«œ</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Birth_certificate" value="no" <%if Birth_certificate ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165"> ”·”· œ—«”Ì »«·„œ—”…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="school_syllabus" value="no" <%if school_syllabus ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">⁄œœ 4 ’Ê— ‘Œ’Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="personal_pic" value="no" <%if personal_pic ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«” „«—…  —ﬂ œ—«”…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="leave_study" value="no" <%if  leave_study="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«” „«—… «⁄«œ… ﬁÌœ</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Re_enrollment_form" value="no" <%if Re_enrollment_form ="no" then%> checked <%End if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">Ã‰”Ì… «·«„ (·√»‰«¡ Ê»‰«  «·ﬂÊÌ Ì« )</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="mother_nationality" value="no" <%if  mother_nationality="no" then%> checked <%End if%>></td>
							</tr>
