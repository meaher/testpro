						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td class="tdDataControlL" width="165">&nbsp;
									...
									«” „«—…  ”ÃÌ· ÿ«·»</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="std_reg_Form" value="no"></td>
							</tr>
								...
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Last_certificate" value="no"></td>
							</tr>
								...
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Nationality_pic" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">’Ê—… «·»ÿ«ﬁ… «·„œ‰Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="ID_pic" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">≈Ì’«· «·—”Ê„</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Fee_receipt" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">’Ê—… «·ÃÊ«“</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="passport_pic" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">’Ê—… ‘Â«œ… «·„Ì·«œ</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Birth_certificate" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165"> ”·”· œ—«”Ì »«·„œ—”…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="school_syllabus" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">⁄œœ 4 ’Ê— ‘Œ’Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="personal_pic" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«” „«—…  —ﬂ œ—«”…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="leave_study" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«” „«—… «⁄«œ… ﬁÌœ</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Re_enrollment_form" value="no"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">Ã‰”Ì… «·«„ (·√»‰«¡ Ê»‰«  «·ﬂÊÌ Ì« )</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="mother_nationality" value="no"></td>
							</tr>
