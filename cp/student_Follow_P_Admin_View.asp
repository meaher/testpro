								...
								<td class="tdDataControlR" width="74%" height="25">
									<%=Managment_Notes%></td>
												...
												<tr>
													...
													<a target="_blank" href="student_Follow_P_Department_print.asp?std_name=<%=std_name%>&id=<%=ID%>&Class_Room=<%=request.querystring("Class_Room")%>&subject_name=<%=request.querystring("subject_name")%>">ÿ»«⁄…</a>&nbsp;
