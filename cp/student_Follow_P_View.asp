				...
				/*
					...
					*/
					...
					<form action="student_Follow_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<input type="hidden" name="Class_id" value="<%=Class_room_id%>">						
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<td class="tdDataControlR" width="74%">
								<%if Teamwork= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165"> Õ÷Ì— 
								«·œ—Ê”</td>
								<td class="tdDataControlR" width="74%">
								<%if Preparing_lessons= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„‘«—ﬂ…</td>
								<td class="tdDataControlR" width="74%">
								<%if share= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">”—⁄… 
								«·«” Ã«»… ··„Â«„</td>
								<td class="tdDataControlR" width="74%">
								<%if Responsiveness= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«· „Ì“ ›Ì 
								«·„‰«ﬁ‘…</td>
								<td class="tdDataControlR" width="74%">
								<%if Discussion= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„—Ê‰… 
								Ê«·„À«»—…</td>
								<td class="tdDataControlR" width="74%">
								<%if Flexibility= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·Õ—’ ⁄·Ï 
								«· ⁄·„</td>
								<td class="tdDataControlR" width="74%">
								<%if care_learn= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„ŸÂ— 
								«·‘Œ’Ì</td>
								<td class="tdDataControlR" width="74%">
								<%if style= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·⁄‰«Ì… 
								»«·√œÊ«  «·„œ—”Ì…</td>
								<td class="tdDataControlR" width="74%">
								<%if Care_Study_Tools= "yes" then%> ‰⁄„<%end if%></td>
							</tr>
							<tr>
							...
							<tr>
								...
								&nbsp;<%=Managment_Notes%></td>
												...
												<tr>
													...
													<a target="_blank" href="student_Follow_P_View_print.asp?std_name=<%=std_name%>&id=<%=ID%>&Class_Room=<%=request.querystring("Class_Room")%>&subject_name=<%=request.querystring("subject_name")%>">ÿ»«⁄…</a>
							...
							<tr>
								...
								<td class="tdDataControlR" width="74%">
									...
									<%if Report_file <> "" then%><a href="/report_file/<%=Report_file%>">⁄—÷ «·„·›</a><%end if%></td>
											...
											<tr>
								<td class="tdDataControlL" width="165"> Ê’Ì«  
								—∆Ì” «·ﬁ”„</td>
								<td class="tdDataControlR" width="74%">
								&nbsp;<%=Managment_Notes%></td>
							</tr>
