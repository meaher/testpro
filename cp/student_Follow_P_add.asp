					...
					<form action="student_Follow_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Teamwork" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165"> Õ÷Ì— 
								«·œ—Ê”</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Preparing_lessons" value="yes"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								«·«” Ã«»… ··„Â«„</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Responsiveness" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«· „Ì“ ›Ì 
								«·„‰«ﬁ‘…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Discussion" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„—Ê‰… 
								Ê«·„À«»—…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Flexibility" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·Õ—’ ⁄·Ï 
								«· ⁄·„</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="care_learn" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„ŸÂ— 
								«·‘Œ’Ì</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="style" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·⁄‰«Ì… 
								»«·√œÊ«  «·„œ—”Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Care_Study_Tools" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">
								<span lang="ar-kw">«·≈Ã—«¡ «·„ Œ–</span></td>
								<td class="tdDataControlR" width="74%">
									<textarea name="notes" rows="8" cols="30" ></textarea></td>
							</tr>
							<tr>
	...
	<tr>
		...
		<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<!-- Start Contents -->
				<div class="PageTitle">
					<span lang="ar-kw"> ”ÃÌ· ÿ«·» „„Ì“</span> «·’› <%=request.querystring("Class_Room")%></div>
					...
					<form action="student_Follow_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<span lang="ar-kw">«·≈Ã—«¡ «·„ Œ–</span></td>
								<td class="tdDataControlR" width="74%">
									<textarea class="textarea" name="notes" id="txtDescEN" rows="5" cols="100%"></textarea></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">—›⁄  ﬁ—Ì— 
								Ê—ﬁÌ</td>
