...
<table class=" w3-left w3-hide-large w3-hover-cyan w3-large w3-theme" border="0" width="100%" id="table1"  style="border-style: solid; background-color: #FFFFFF !important">
	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<!-- Start Contents -->
				<div class="PageTitle">
					<span lang="ar-kw"> ⁄œÌ·</span> <span lang="ar-kw"> ﬁ—Ì— 
					«·ÿ«·» «·„„Ì“</span> «·’› <%=request.querystring("Class_Room")%></div>
					...
					*/
					...
					<form action="student_Follow_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<td class="tdDataControlR" width="74%">
									...
									<select size="1" name="Exam_Degree" class="select">
										<option value="<%=Exam_Degree%>" ><%=Class_Degree%></option>
									<%for i=1 to 69%>
														<option value="<%=i%>"><%=i%></option>
														<option value="<%=i%>.5"><%=i%>.5</option>
														
									<%next%>
										<option value="70"  <%if Exam_Degree="70" then%> selected <%End if%>>70</option>
									</select>
							...
							<tr>
								<td class="tdDataControlL" width="165">«·⁄„· «·Ã„«⁄Ì</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Teamwork" value="yes"  <%if Teamwork= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165"> Õ÷Ì— 
								«·œ—Ê”</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Preparing_lessons" value="yes"  <%if Preparing_lessons= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„‘«—ﬂ…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="share" value="yes"  <%if share= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">”—⁄… 
								«·«” Ã«»… ··„Â«„</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Responsiveness" value="yes"  <%if Responsiveness= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«· „Ì“ ›Ì 
								«·„‰«ﬁ‘…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Discussion" value="yes"  <%if Discussion= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„—Ê‰… 
								Ê«·„À«»—…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Flexibility" value="yes"  <%if Flexibility= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·Õ—’ ⁄·Ï 
								«· ⁄·„</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="care_learn" value="yes"  <%if care_learn= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·„ŸÂ— 
								«·‘Œ’Ì</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="style" value="yes"  <%if style= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·⁄‰«Ì… 
								»«·√œÊ«  «·„œ—”Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Care_Study_Tools" value="yes"  <%if Care_Study_Tools= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·≈Ã—«¡ 
								«·„ Œ–</td>
								<td class="tdDataControlR" width="74%">
									<textarea  name="notes" rows="5" cols="29"><%=notes%></textarea></td>
							</tr>
							<tr>
								...
								<input type=file  name="txtImg" class="textBox" size="35"><%if Report_file <> "" then%><a href="/report_file/<%=Report_file%>">⁄—÷ «·„·›</a><%end if%></td>
							</tr>
					...
					<form action="student_Follow_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								«·„ Œ–</td>
								<td class="tdDataControlR" width="74%">
									<textarea class="textarea" name="notes" id="txtDescEN" rows="5" cols="100%"><%=notes%></textarea></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">—›⁄  ﬁ—Ì— 
								Ê—ﬁÌ</td>
