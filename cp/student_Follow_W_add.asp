...
<table class=" w3-left w3-hide-large w3-hover-cyan w3-large w3-theme" border="0" width="100%" id="table1"  style="border-style: solid; background-color: #FFFFFF !important">
	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<!-- Start Contents -->
				<div class="PageTitle">
					 ”ÃÌ· „ «»⁄… <span lang="ar-kw">«·ÿ·»… «·÷⁄«›</span> «·’› <%=request.querystring("Class_Room")%></div>
				...
				/*
					...
					*/
					...
					<form action="student_Follow_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<input type="hidden" name="Follow_type" value="2">						
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<select size="1" name="Class_Degree0" class="select">
									<%for i=1 to 29%>
							...
							<tr>
								...
								<td class="tdDataControlR" width="74%">
									...
									<select size="1" name="Exam_Degree0" class="select">
									<%for i=1 to 69%>
														<option value="<%=i%>"><%=i%></option>
														<option value="<%=i%>.5"><%=i%>.5</option>
							...
							<tr>
								<td class="tdDataControlL" width="165">«·„‘«—ﬂ… 
								«·’›Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Class_Participation" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">«·Ê«Ã»«  
								«·„‰“·Ì…</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Home_work" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">ﬂÀ—… «·€Ì«»</td>
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Absence" value="yes"></td>
							</tr>
							<tr>
								<td class="tdDataControlL" width="165">
								<span lang="ar-kw">«·≈Ã—«¡ «·„ Œ–</span></td>
								<td class="tdDataControlR" width="74%">
									<textarea  name="notes" rows="5" cols="28"  ></textarea></td>
							</tr>
							<tr>
	...
	<tr>
		...
		<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<!-- Start Contents -->
				<div class="PageTitle">
					<span lang="ar-kw"> ”ÃÌ· „ «»⁄… «·ÿ·»… «·÷⁄«›</span> «·’› <%=request.querystring("Class_Room")%></div>
