...
<table class=" w3-left w3-hide-large w3-hover-cyan w3-large w3-theme" border="0" width="100%" id="table1"  style="border-style: solid; background-color: #FFFFFF !important">
	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<!-- Start Contents -->
				<div class="PageTitle">
					<span lang="ar-kw">⁄—÷ »Ì«‰«  </span>«·„ «»⁄… «·’› <%=request.querystring("Class_Room")%></div>
							...
							<tr>
								...
								&nbsp;<%=Managment_Notes%></td>
												...
												<tr>
													...
													<a target="_blank" href="student_Follow_w_View_print.asp?std_name=<%=std_name%>&id=<%=ID%>&Class_Room=<%=request.querystring("Class_Room")%>&subject_name=<%=request.querystring("subject_name")%>">ÿ»«⁄…</a>
