...
elseif procType="edit" then
	...
	conn.close
	set conn=nothing
	if Upload.Form("page")=1 then
		response.redirect "student_behavior_admin_new.asp?class_Room_id="&Upload.Form("Class_Room_id")&"&class_room="&Upload.Form("Class_room")&"&start=1" 
	Elseif Upload.Form("page")=2 then
		response.redirect "student_behavior_admin_All.asp?class_Room_id="&Upload.Form("Class_Room_id")&"&class_room="&Upload.Form("Class_room")&"&start=1" 
	Else
		response.redirect "student_behavior_admin_list.asp?class_Room_id="&Upload.Form("Class_Room_id")&"&class_room="&Upload.Form("Class_room")&"&start=1" 
	End if
