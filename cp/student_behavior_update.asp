	...
	<table border="0" width="98%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<td width="70%" valign="top">
								<!-- Start Contents -->
				<div class="PageTitle">
					<span lang="ar-kw"> ⁄œÌ·</span> <span lang="ar-kw"> ﬁ—Ì—</span> «·’› <%=request.querystring("Class_Room")%></div>
						...
						<table class="tblDataControl" cellpadding="3" cellspacing="0">
							...
							<tr>
								...
								<select size="1" name="Lecture_Time_id" class="select">
										...
										while not rs.eof
										%>
														<option value="<%=rs("Lecture_Time_id")%>" <%if rs("Lecture_Time_id")=Lecture_Time_id then%> selected <%End if%>><%=Rs("Lecture_Time_name")%></option>
										<%
											rs.movenext
										wend
										set rs=nothing
								...
								<td class="tdDataControlR" width="74%">
								<input type="checkbox" name="Smoking" value="yes" <%if Smoking= "yes" then%> checked<%end if%>></td>
							</tr>
							<tr>
							...
							<tr>
								...
								«·„⁄·„</td>
								<td class="tdDataControlR" width="74%">
									<textarea class="textarea" name="notes" id="txtDescEN" rows="1" cols="20"><%=notes%></textarea></td>
							</tr>
							<tr>
