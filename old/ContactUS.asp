...
<div align="center">
	<table bgcolor=#FFFFFF border="0" width="900" id="table1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<img border="0" src="Images/Esehamk.jpg" width="72" height="32"></font></td>
					</tr>
				</table>
			</div>
			<p></p>
		...
		<script>
function chkform(){
	var Subject=document.frm.tSubject.value;
	...
	return false;
		...
		<form action="Contactsend.asp" method=POST name=frm onsubmit="return chkform();">		
		<div align="center">
		<table border="0" width="95%" id="table35" style="border-collapse: collapse" cellpadding="3">
			<tr>
				<td align="left">«·»—Ìœ «·≈·ﬂ —Ê‰Ì:</td>
				<td><font color="#000080"><a href="mailto:htssch2@gmail.com">
				htssc<span lang="en-us">h</span>2<span lang="en-us">@gmail.</span>c<span lang="en-us">om</span></a>
				<a href="mailto:htssch@gmail.com">htssc<span lang="en-us">h@gmail.</span>c<span lang="en-us">om</span></a></font></td>
			</tr>


			<tr>
				<td align="left">«·«”„:<font color="#FF0000"> </font></td>
				<td align="right"><input type="text" name="tName" size="40"></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="left">„Ê÷Ê⁄ «·—”«·…:<font color="#FF0000"> </font></td>
				<td align="right"><input type="text" name="tSubject" size="40"></td>
			</tr>
			<tr>
