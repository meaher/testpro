		...
		<tr>
			...
			&nbsp;</td>
						...
						<td>
							...
							<table border="0" width="98%" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<a href="forum.asp">À«‰ÊÌ ‰«</a> <font size="4"> ª</font><a href="Forum_Subjects.asp?ID=<%=intID%>"> <%=rs("Room_Name")%></a>
									<%RoomID = Rs("Room_ID")%>
									<%rs.close%>
									<%
									...
									%>
									<%="<br>&nbsp;&nbsp;<font size='4'>ª</font> <a href='Forum_Comment.asp?SID="& SubID &"'> " & rs("Sub_Header") &"</a>" %>
									</p>
				...
				&nbsp;</td>
										...
										<tr>
											<td width="10%">
				<p align="right"><span lang="ar-kw"><b>«·—œ</b>:</span></td>
											<td width="89%">
