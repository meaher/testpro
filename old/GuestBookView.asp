	...
	<table bgcolor=#FFFFFF border="0" width="900" id="table1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<img src="images/el-ameed_42.gif" width="22" height="22" alt=""></td>
						<td>
									<font face="Sultan normal" size="5"><img border="0" src="Images/GustBook.jpg" width="100" height="29"></font></td>
					</tr>
				</table>
			</div>
			<p></p>
...
<%
	...
	sSql= "Select * From GuestBook where Active = True"
...
<% End If %>
					...
					<tr>
						<td width="108" valign="top"><span lang="ar-kw">«·«”„:</span></td>
						<td><span lang="ar-kw"><%=rs("FullName")%></span></td>
					</tr>
					<tr>
						<td width="108" valign="top"><span lang="ar-kw">«·»·œ:</span></td>
						<td><span lang="ar-kw"><%=rs("Country")%></span></td>
					</tr>
					<tr>
						<td width="108" valign="top"><span lang="ar-kw"> «—ÌŒ «·„‘«—ﬂ…:</span></td>
						<td><span lang="ar-kw"><%=rs("AddDate")%></span></td>
					</tr>
					<tr>
						<td width="108" valign="top"><span lang="ar-kw">«·„‘«—ﬂ…:</span></td>
						<td><span lang="ar-kw"><p align="justify"><%=rs("Details")%></p></span></td>
					</tr>
				</table>
				<br>
...
If nTotalRecs > 0 Then
	...
	If CLng(nTotalRecs) > CLng(nDisplayRecs) Then
		...
		<a href="GuestBookView.asp?start=<%=PrevStart%>"><b>
<font size="2" color="#000080">«·”«»ﬁ</font></b></a><font size="2" color="#000080">
		...
		<a href="GuestBookView.asp?start=<%=x%>"><b>
...
<font size="2" color="#000080"><%=y%>-<%=ny%></font></b></a><font size="2" color="#000080">
		...
		<a href="GuestBookView.asp?start=<%=NextStart%>"><b>
