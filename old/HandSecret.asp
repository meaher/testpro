...
<div align="center">
	<table bgcolor=#FFFFFF border="0" width="900" id="table1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<img border="0" src="Images/HandSecret.jpg" width="80" height="29"></font></td>
					</tr>
				</table>
			</div>
			<p></p>
			...
			<div align="center">
				<table border="0" width="98%" id="table9">
					...
					<tr>
						<td colspan="2">
						<img border="0" src="Images/folder.gif" width="20" height="20">&nbsp;
						<a href="HandSecret1.asp">Õ Ï «·„·· ·Â ›Ê«∆œ ⁄‰œ «·√ÿ›«· 
						›‘Ã⁄Â„ ⁄·ÌÂ.</a></td>
					</tr>
					<tr>
						<td colspan="2">
					...
					<tr>
						<td colspan="2">
						<img border="0" src="Images/folder.gif" width="20" height="20">&nbsp;
						<a href="HandSecret2.asp">ﬂÌ› Ì„ﬂ‰  ÕﬁÌﬁ «· —ﬂÌ“ ›Ì «·œ—«”… Ê«·Œ‘Ê⁄ ›Ì «·’·«…ø</a></td>
					</tr>
					<tr>
						<td colspan="2">
						&nbsp;</td>
