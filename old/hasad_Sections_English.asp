	...
	<table bgcolor=#FFFFFF border="0" width="900" id="table1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<img src="images/el-ameed_42.gif" width="22" height="22" alt=""></td>
						<td><img border="0" src="Images/Hasad.jpg" width="80" height="28"></td>
					</tr>
				</table>
			</div>
			</font></div>
			...
			<div align="center">
				<table border="0" width="98%" id="table9" dir="ltr">
					<tr>
						<td valign="top">
						<p align="justify"><span lang="ar-sa"><u><b>Õ’«œ ﬁ”„ 
						«··€… «·≈‰Ã·Ì“Ì…:</b></u></span></p>
						<p align="justify">&nbsp;</p>
						</td>
						<td valign="top">
...
&nbsp;<table border="0" width="100%" id="table11">
					...
					<tr>
						...
						Mr. </b><p align="justify">
						<b><u>The Team Leader:</u><br>
						<br>
						&nbsp;</b><p align="justify">
						<u>
						<b>E</b><span lang="ar-sa"><b>nclosed:</b></span></u><p align="justify">
						<b>
						<a  href="#" onclick="window.open('hasad_Sections_Lsn.asp?Section=English&SName=Nader.rm','OpenPage','menubar=no,width=350,height=450')">
							- Special lecture by Mr.</a></b> <b>
								<span lang="ar-sa">
						(	
						<a  href="#" onclick="window.open('hasad_Sections_Lsn.asp?Section=English&SName=Nader.rm','OpenPage','menubar=no,width=350,height=450')">
						...
						<a  href="Sections_Toturiels/English/Nader.rm">
						<img border="0" src="Images/download.gif" width="16" height="16"></a>
						&nbsp;)</span>.</b><p align="center">
						<b>To save please press the link 
							<span lang="ar-sa">
						<img border="0" src="Images/download.gif" width="16" height="16"></span> 
						beside lecture name with <br>
						using right click thin choice
							<span lang="ar-sa">
						Save target as</span>.</b><p align="center">
						&nbsp;</td>
					</tr>
					<tr>
						<td colspan="2">
