	...
	<table bgcolor=#FFFFFF border="0" width="900" id="table1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<img src="images/el-ameed_42.gif" width="22" height="22" alt=""></td>
						<td><font face="Sultan normal" size="5"><img border="0" src="Images/Hasad.jpg" width="80" height="28"></font></td>
					</tr>
				</table>
			</div>
			<p></p>
			</font></div>
							<table border="0" width="98%" id="table7" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
								<tr>
			...
			<div align="center">
				<table border="0" width="98%" id="table9">
					<tr>
						...
						<p align="justify"><u><span lang="ar-sa"><b>Õ’«œ ﬁ”„ 
						«· —»Ì… «·≈”·«„Ì…:</b></span></u></p>&nbsp;<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
...
&nbsp;</span></p>
					...
					<tr>
						<td colspan="2">
						<p align="justify">
						<span lang="ar-sa"><b>«·„—›ﬁ« :</b></span><p align="justify">
						<b>

						
						<a  href="#" onclick="window.open('hasad_Sections_Lsn.asp?Section=Islamyah&SName=Rashed.rm','OpenPage','menubar=no,width=350,height=450')"> - œ—” ‰„Ê–ÃÌ √/.</a>
						<span lang="ar-sa">
						(	
						<a  href="#" onclick="window.open('hasad_Sections_Lsn.asp?Section=Islamyah&SName=Rashed.rm','OpenPage','menubar=no,width=350,height=450')">
						<img border="0" src="Images/Listenrm.gif" width="17" height="16"></a>
						)
						&nbsp;&nbsp; (
						
						<a  href="Sections_Toturiels/Islamyah/Rashed.rm">
						<img border="0" src="Images/download.gif" width="16" height="16"></a>
						&nbsp;)</span></b><p align="center">
						<b><span lang="ar-sa">
						<br>
						··Õ›Ÿ «÷€ÿ ⁄·Ï «·—«»ÿ</span> 
							<span lang="ar-sa">
						<img border="0" src="Images/download.gif" width="16" height="16"></span>
							<span lang="ar-sa">
						«·„ÊÃÊœ Ã«‰» «”„ «·„Õ«÷— »Ì„Ì‰ «·›√—… Ê«Œ —<br>
&nbsp;Õ›Ÿ «·Âœ› »«”„ √Ê Save target as					
	<br>
&nbsp;</span></b></td>
					</tr>
					<tr>
