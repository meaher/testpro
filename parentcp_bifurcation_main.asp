...
<table border="0" cellpadding="0" cellspacing="0" width="95%" style="border: 1px solid #999999; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bgcolor="#FFFFFF">
			...
			<span lang="en-us">
			&nbsp;</span><span lang="ar-kw">«” „«—…  ÕœÌœ «· Œ’’ ··’› «·Õ«œÌ ⁄‘— ··⁄«„ 
			«·ﬁ«œ„ 2022-2023</span><img src="images/el-ameed_42.gif" width="22" height="22" alt=""><p style="text-align: right">
			<div class="ErrMsg">
				<%
					...
					<form action="Parentcp_bifurcation_chk.asp" method="post" name="frmData" id="frmData" onsubmit="return ValidateData()"  enctype="multipart/form-data">
						...
						<input type="hidden" name="Class_Room_ID" value="<%=Class_Room_ID%>">	
								...
								<tr>
									<td>&nbsp;</td>
									<td>
									<input type="radio" name="bifurcation" value="1" checked><span lang="ar-kw">⁄·„Ì</span></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>
														
									<input type="radio" name="bifurcation" value="2"><span lang="ar-kw">√œ»Ì</span></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>
...
<table class="w3-hide-medium w3-hide-small" border="0" width="100%"  cellspacing="0" cellpadding="0" style="border-style: solid; background-color: #F9FCFF !important">
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0" dir="rtl">
			...
			<span lang="en-us">
			&nbsp;</span><span lang="ar-kw">«” „«—…  ÕœÌœ «· Œ’’ ··’› «·Õ«œÌ ⁄‘— ··⁄«„ 
			«·ﬁ«œ„ 2022-2023</span><img src="images/el-ameed_42.gif" width="22" height="22" alt=""><p style="text-align: right"><font color="#FF0000">&nbsp;<%=session("ErrMsg")%></font>
											<p>
					<div class="ErrMsg">
				<%
				if session("Errmsg")<> "" then 
