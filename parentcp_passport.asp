...
<form action="parentcp_Passport_loginCheck.asp" method=post onsubmit="return checkLoginData()" name="fLoginData">
				<div align="center">
			...
			<img src="images/el-ameed_42.gif" width="22" height="22" alt=""><span lang="en-us">
			</span>«·‰Ÿ«„ «·Œ«’ »„⁄·Ê„«  <span lang="ar-kw">ÃÊ«“ «·”›—</span></td>
						</tr>
						<tr>
							<td height="20" align="center">
							<font color="#FF0000">&nbsp;<%=session("ErrMsg")%></font>
						...
						<tr>
							<td height="150" align="center">
								...
								<table border="0" width="95%" cellspacing="0" cellpadding="2" dir="rtl" align="right">
									<tr>
